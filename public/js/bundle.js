...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = React.createFactory(__webpack_require__(158));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var Echo = __webpack_require__(159);
	  ...
	  render:function() {
	    return (
	        React.createElement("div", null, 
	            React.createElement("h2", null, "Echo"), 
	            React.createElement("div", {id: "echo-component"}, 
	                React.createElement("label", null, 
	                    "Type some text into the field below.", React.createElement("br", null), React.createElement("br", null), 
	                    React.createElement("input", {type: "text", onChange: this.doEcho})
	                ), 
	                React.createElement("p", null, React.createElement("span", null, (this.state.text === '') ? 'You haven\'t typed anything yet' : (this.state.text.toLowerCase() === 'marco') ? 'POLO!!!' : 'You typed ' + this.state.text))
	            )
	        )
	    );
	  },
